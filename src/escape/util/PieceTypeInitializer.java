 ...
 * course was taken at Worcester Polytechnic Institute.
 *
 ...
 * package escape.util;
 * 
 * import java.util.Arrays; import escape.required.EscapePiece.*; COMMENTED FOR
 * COVERAGE
 *
 * A general initializer for a piece type. Since this is used internally, we
 * take a shortcut and make the instance variables public rather than private
 * since this class is not part of the actual game implementation.
 * 
 * This file mirrors the <pieceTypes> structure in the XML configuration files.
 * 
 ...
 * 
 * MODIFIABLE: YES MOVEABLE: YES REQUIRED: NO
 */
...
public class PieceTypeInitializer {
	...
	/*
	 * public PieceName getPieceName() { return pieceName; } //** /* @param
	 * pieceName the pieceName to set
	 */
	 ...
	 * "PieceTypeInitializer [pieceName=" + pieceName + ", movementPattern=" +
